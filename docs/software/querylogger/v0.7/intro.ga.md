...
| Pacáiste | NuGet Stable | NuGet Prerelease | Íoslódálacha |
| -------- | ------------ | ----------------- | --------- |
...
- Is féidir le hiarratais GUID a roinnt, agus ciallaíonn sé seo gur féidir leat iarratais gaolmhara éagsúla a chur i ngrúpaí.
