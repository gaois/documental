...
<div class='home'>
	<header>
		...
		<p>{@html $_('home.tagline', { values:
			{ link: `<a rel='noopener' href='https://www.gaois.ie/${$locale}'>${$_(`global.groupName`)}</a>` }
		})}</p>
	</header>
	<section>
		...
		<ul>
			<li>
				<article>
					<a href={`/${$locale}/data/general`}>
						<h3>{$_('home.sections.gettingStarted')}</h3>
						<p>{$_('home.sections.gettingStartedBlurb')}</p>
					</a>
				</article>
			</li>
			<li>
				<article>
					<a href={`/${$locale}/data/duchas/v0.5/api`}>
						<h3>Dúchas</h3>
						<p>{$_('home.sections.duchasBlurb')}</p>
					</a>
				</article>
			</li>
			<li>
				<article>
					<a href={`/${$locale}/data/logainm/v0.9/api`}>
						<h3>Logainm</h3>
						<p>{$_('home.sections.logainmBlurb')}</p>
					</a>
				</article>
			</li>
			<li>
				<article>
					<a href={`/${$locale}/data/surnames`}>
						<h3>{$_('home.sections.surnames')}</h3>
						<p>{$_('home.sections.surnamesBlurb')}</p>
					</a>
				</article>
			</li>
		</ul>
			...
			<li>
				<article>
					<a href={`/${$locale}/software/terminologue/intro`}>
						<h3>Terminologue</h3>
						<p>{$_('home.sections.terminologueBlurb')}</p>
					</a>
				</article>
			</li>
			<li>
				<article>
					<a href={`/${$locale}/software/geonames2sql`}>
						<h3>GeoNames2Sql</h3>
						<p>{$_('home.sections.geoNames2SqlBlurb')}</p>
					</a>
				</article>
			</li>
			<li>
				<article>
					<a href={`/${$locale}/software/localizer`}>
						...
						<p>{$_('home.sections.localizerBlurb')}</p>
					</a>
				</article>
			</li>
			<li>
				<article>
					<a href={`/${$locale}/software/querylogger/v0.7/intro`}>
						...
						<p>{$_('home.sections.queryLoggerBlurb')}</p>
					</a>
				</article>
			</li>
		</ul>
